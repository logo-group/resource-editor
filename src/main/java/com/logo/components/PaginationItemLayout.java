...
import com.logo.data.ReProjectVersion;
...
import com.logo.form.ResourceItemWindow;
import com.logo.form.ResourceWindow;
...
import com.logo.util.StrToIntegerConverter;
...
public class PaginationItemLayout extends ResponsiveLayout{
	...
	public VerticalLayout generatePanelLayout() {
		...
		Page<com.logo.data.ReResourceitem> resourceItems;
	...
	private Page<com.logo.data.ReResourceitem> preareCondition(int page, int size) {
		String nameilter = "";
		Page<com.logo.data.ReResourceitem> resourceItems = null;
	...
	private Panel createPanel(ArrayDeque<com.logo.data.ReResourceitem> resourceitems) {
	...
	private GridLayout changeContent(ArrayDeque<com.logo.data.ReResourceitem> resourceitems) {
	...
	public Page<com.logo.data.ReResourceitem> searchByresourcereTR(int page, int size, String nameFilter) {
		Pageable pageable = new PageRequest(page, size, null);
		return reResourceitemRep.searchByresourcereTR(nameFilter, pageable);
	}

	public Page<com.logo.data.ReResourceitem> searchByresourceParam(int page, int size, SearchParam sParam) {
		Pageable pageable = new PageRequest(page, size, null);
		return reResourceitemRep.searchByParam(pageable, sParam);
	}

	public Page<com.logo.data.ReResourceitem> searchByresourceParamAll(int page, int size, SearchParam sParam) {
		Pageable pageable = new PageRequest(page, size, null);
		return reResourceitemRep.searchByParamAll(pageable, sParam);
	}

	public Page<com.logo.data.ReResourceitem> searchByresourceNr(int page, int size, String nameFilter, String resourcegroup) {
		Pageable pageable = new PageRequest(page, size, null);
		return reResourceitemRep.searchByresourceNr(pageable,nameFilter,resourcegroup);
	}

	@SuppressWarnings("unchecked")
	public Page<com.logo.data.ReResourceitem> getAllResItems(int page, int size, String nameFilter) {
		Pageable pageable = new PageRequest(page, size, null);
